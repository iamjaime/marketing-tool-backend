...
Route::group(['prefix' => 'v1'], function () {
    ...
    Route::post('stripe/customer/webhook', 'PaymentController@stripeCustomerWebHook');
    Route::post('stripe/withdraw/webhook', 'PaymentController@stripeWithdrawalWebHook');
